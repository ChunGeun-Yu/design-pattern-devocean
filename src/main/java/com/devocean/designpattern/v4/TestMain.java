...
public class TestMain implements ApplicationRunner {
    ...
    private final AlarmServiceV4 alarmService;
    ...
    public TestMain(AlarmServiceV4 alarmService, EmailNotification emailNotification, SlackNotification slackNotification) {
