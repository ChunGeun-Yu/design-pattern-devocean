...
public class TestMain implements ApplicationRunner {
    ...
    private final AlarmServiceV3 alarmService;
    ...
    public TestMain(AlarmServiceV3 alarmService, EmailNotification emailNotification, SlackNotification slackNotification) {
